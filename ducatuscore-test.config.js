...
testConfig.eonaCoreNode.chains.BNB.regtest.trustedPeers[0].host = 'geth';
testConfig.eonaCoreNode.chains.BNB.regtest.trustedPeers[0].port = 30303;
testConfig.eonaCoreNode.chains.BNB.regtest.providers[0].host = 'geth';
testConfig.eonaCoreNode.chains.BNB.regtest.providers[0].port = 8546;
